...
\begin{xltabular}{\textwidth}{|
  ...
  \stepcounter{requirement}F\rownumber                     & Pre-Made battle Environment  & Implementation of a pre-made battle environment that can be used to test agents.                                                                      & M               \\\hline                                                                                                                                
  \stepcounter{requirement}F\rownumber                     & Battle Environment           & Turn-based battle simulator that can take inputs from an agent.                                                                                       & S               \\\hline
  ...
  \stepcounter{requirement}F\rownumber                     & Upload To Cloud              & Upload agent and environment to a cloud service, for 24/7 hour training                                                                               & W               \\\hline
